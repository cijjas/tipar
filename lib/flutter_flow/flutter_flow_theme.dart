...
abstract class FlutterFlowTheme {
  ...
  late Color letrasgris;
  late Color letrasnegro;
  late Color textbox;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color mainbackground = Color(0xFFF6F8FA);
  late Color letrasgris = Color(0xFF657786);
  late Color letrasnegro = Color(0xFF00071B);
  late Color textbox = Color(0xFFAAB8C2);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color mainbackground = Color(0xFFE3C6C4);
  late Color letrasgris = Color(0xFF9CD7DE);
  late Color letrasnegro = Color(0xFF99E988);
  late Color textbox = Color(0xFF10DAE3);
  late Color primaryBtnText = Color(0xFFFFFFFF);
