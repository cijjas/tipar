  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final employeeHomeUsersRecord = snapshot.data!;
                                                          ...
                                                          StreamBuilder<
                                                            ...
                                                            builder: (context,
                                                              ...
                                                              return Text(
                                                                valueOrDefault<
                                                                    String>(
                                                                  (employeeHomeUsersRecord.isEmployee ==
                                                                              true
                                                                          ? valueOrDefault<
                                                                              double>(
                                                                              employeeHomeUsersRecord.totalTips,
                                                                              0.0,
                                                                            )
                                                                          : employeeHomeUsersRecord
                                                                              .totalPoints
                                                                              .toDouble())
                                                                      .toString(),
                                                                  '0',
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                                      StreamBuilder<List<HistorialTipsRecord>>(
                                        stream: queryHistorialTipsRecord(
                                          queryBuilder: (historialTipsRecord) =>
                                              historialTipsRecord.orderBy(
                                                  'time',
                                                  descending: true),
                                          limit: 4,
                                        ),
