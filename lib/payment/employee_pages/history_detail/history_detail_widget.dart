...
class HistoryDetailWidget extends StatefulWidget {
  const HistoryDetailWidget({
    Key? key,
    required this.detalleTip,
  }) : super(key: key);

  final DocumentReference? detalleTip;
...
class _HistoryDetailWidgetState extends State<HistoryDetailWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<HistorialTipsRecord>(
      stream: HistorialTipsRecord.getDocument(widget.detalleTip!),
      builder: (context, snapshot) {
        ...
        final historyDetailHistorialTipsRecord = snapshot.data!;
                                            ...
                                            child: Container(
                                              ...
                                              child: AuthUserStreamWidget(
                                                builder: (context) => Text(
                                                  'Importe ${valueOrDefault<bool>(currentUserDocument?.isEmployee, false) == true ? 'Recibido' : 'Enviado'}',
                                          ...
                                          Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  formatNumber(
                                                    historyDetailHistorialTipsRecord
                                                        .tipAmount,
                                                    formatType:
                                                        FormatType.decimal,
