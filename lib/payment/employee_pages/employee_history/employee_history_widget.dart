...
import 'employee_history_model.dart';
export 'employee_history_model.dart';

class EmployeeHistoryWidget extends StatefulWidget {
  const EmployeeHistoryWidget({Key? key}) : super(key: key);

  @override
  _EmployeeHistoryWidgetState createState() => _EmployeeHistoryWidgetState();
}

class _EmployeeHistoryWidgetState extends State<EmployeeHistoryWidget> {
  late EmployeeHistoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EmployeeHistoryModel());
  }
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 10.0, 0.0, 0.0),
                                    child: StreamBuilder<
                                        List<HistorialTipsRecord>>(
                                      stream: queryHistorialTipsRecord(
                                        queryBuilder: (historialTipsRecord) =>
                                            historialTipsRecord.orderBy('time',
                                                descending: true),
                                      ),
                                        ...
                                        return SingleChildScrollView(
                                          child: Column(
                                            ...
                                            children: List.generate(
                                                columnHistorialTipsRecordList
                                                    .length, (columnIndex) {
                                              final columnHistorialTipsRecord =
                                                  columnHistorialTipsRecordList[
                                                      columnIndex];
                                              return Padding(
