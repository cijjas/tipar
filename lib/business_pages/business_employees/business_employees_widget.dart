...
import 'business_employees_model.dart';
export 'business_employees_model.dart';

class BusinessEmployeesWidget extends StatefulWidget {
  const BusinessEmployeesWidget({Key? key}) : super(key: key);

  @override
  _BusinessEmployeesWidgetState createState() =>
      _BusinessEmployeesWidgetState();
}

class _BusinessEmployeesWidgetState extends State<BusinessEmployeesWidget> {
  late BusinessEmployeesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BusinessEmployeesModel());
  }
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Container(
                                                          ...
                                                          child: Image.network(
                                                            'https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fwww.gamba.cl%2Fwp-content%2Fuploads%2F2019%2F11%2Fharold-hide-the-pain-2.jpg&f=1&nofb=1&ipt=47ecbcceb4f268547c0df5770cc60c5c45f4bc8b65634ca5dd793eb7f6c40a67&ipo=images',
                                                            fit: BoxFit.contain,
                                                          ),
                                                        ),
                                                        Column(
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        Container(
                                                          ...
                                                          child: Image.network(
                                                            'https://i1.sndcdn.com/artworks-ghKShmynapnkePdZ-wxuyDg-t500x500.jpg',
                                                            fit: BoxFit.contain,
                                                          ),
                                                        ),
                                                        Column(
