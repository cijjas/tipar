...
import 'schema/historial_tips_record.dart';
...
export 'schema/historial_tips_record.dart';
...
/// Functions to query HistorialTipsRecords (as a Stream and as a Future).
Future<int> queryHistorialTipsRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      HistorialTipsRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<HistorialTipsRecord>> queryHistorialTipsRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      HistorialTipsRecord.collection(parent),
      HistorialTipsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<HistorialTipsRecord>> queryHistorialTipsRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<FFFirestorePage<HistorialTipsRecord>> queryHistorialTipsRecordPage({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
...
Future<int> queryEmployeesRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      EmployeesRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
Future<FFFirestorePage<EmployeesRecord>> queryEmployeesRecordPage({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
