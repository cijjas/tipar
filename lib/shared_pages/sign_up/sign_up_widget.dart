...
class _SignUpWidgetState extends State<SignUpWidget> {
  ...
  void initState() {
    ...
    _model.cliNamefieldController ??= TextEditingController();
    _model.cliLastfieldController ??= TextEditingController();
    _model.cliPhonefieldController ??= TextEditingController();
    _model.cliCityfieldController ??= TextEditingController();
    _model.nombreFieldController ??= TextEditingController();
    _model.apellidoFieldController ??= TextEditingController();
    _model.telefonoFieldController ??= TextEditingController();
    _model.empleadorFieldController ??= TextEditingController();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<BusinessRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<BusinessRecord> signUpBusinessRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final signUpBusinessRecord = signUpBusinessRecordList.isNotEmpty
            ? signUpBusinessRecordList.first
            : null;
                      ...
                      child: Column(
                        children: [
                          Align(
                            ...
                            child: TabBar(
                              labelColor: Color(0xFF032C55),
                              labelStyle:
                                  FlutterFlowTheme.of(context).bodyMedium,
                              indicatorColor: Color(0x00054B92),
                              tabs: [
                                Tab(
                                  text: 'Cliente',
                                ),
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  maxLines: null,
                                                  validator: _model
                                                      .cliNamefieldControllerValidator
                                                      .asValidator(context),
                                                ),
                                              ),
                                            ),
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  validator: _model
                                                      .cliLastfieldControllerValidator
                                                      .asValidator(context),
                                                ),
                                              ),
                                            ),
                                        ...
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              validator: _model
                                                  .cliPhonefieldControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ),
                                        ...
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              validator: _model
                                                  .cliCityfieldControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ),
                                        ...
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              validator: _model
                                                  .telefonoFieldControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ),
                                        ...
                                        Expanded(
                                          child: Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              validator: _model
                                                  .empleadorFieldControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ),
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          await currentUserReference!
                                            ...
                                            phoneNumber: _model
                                                .telefonoFieldController.text,
                                            photoUrl: '',
                                            worksIn: _model
                                                .empleadorFieldController.text,
                                            isEmployee: true,
                                            totalTips: 0.00,
                                            avgRating: 0.00,
                                            quantityTips: 0,
                                          ...
                                          await EmployeesRecord.createDoc(
                                                  signUpBusinessRecord!
                                                      .reference)
                                              .set(createEmployeesRecordData(
                                            firstName: _model
                                                .nombreFieldController.text,
                                            lastName: _model
                                                .apellidoFieldController.text,
